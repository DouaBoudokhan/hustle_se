...
export default function Navigation() {
  ...
  return (
    <nav className={`navbar navbar-expand-lg ${pathname === '/' ? 'navbar-transparent' : 'navbar-solid'}`}>
      <div className="container d-flex justify-content-between">
        <Link href="/" className="navbar-brand">Hustle</Link>
              ...
              <>
                ...
                <li className="nav-item mx-2">
                  <div className="position-relative">
                    ...
                    {showNotifications && (
                      <div className="position-absolute end-0 mt-2 py-2 bg-white rounded-3 shadow-lg notification-dropdown">
                                  ...
                                  <div className="d-flex justify-content-between align-items-center">
                                    ...
                                    <div className="flex items-center gap-2">
                                      <button
                                        onClick={async () => {
                                          try {
                                            const response = await fetch(`/api/request?id=${request.id_request}&action=accept`, {
                                              method: 'PATCH',
                                            });
                                            if (response.ok) {
                                              fetchPendingRequests();
                                      ...
                                      <button
                                        onClick={async () => {
                                          try {
                                            const response = await fetch(`/api/request?id=${request.id_request}`, {
                                              method: 'DELETE',
                                            });
                                            if (response.ok) {
                                              fetchPendingRequests();
